...
describe("Candidate", () => {
	...
	test("render", () => {
		...
		expect(wrapper.find(".Candidate-Promises li")).toHaveLength(props.promises.length);
		expect(wrapper.find(".Candidate-Careers li")).toHaveLength(props.careers.length);
	});
});